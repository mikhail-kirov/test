...
CREATE INDEX items_ownerId ON items(ownerId);
...
CREATE INDEX bookings_itemId ON bookings(itemId);
CREATE INDEX bookings_bookerId ON bookings(bookerId);
...
CREATE INDEX comments_itemId ON comments(itemId);
...
CREATE TABLE requests (
                          ...
                          created timestamp,
                          CONSTRAINT requests_users_fk FOREIGN KEY (userId) REFERENCES users(id) ON DELETE CASCADE
);
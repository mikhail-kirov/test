...
import ru.practicum.shareit.validation.item.ValidationComment;
...
public class ItemServiceImpl implements ItemService {
    ...
    private final ValidationComment validationComment;
    ...
    public ItemDto addItem(Long userId, ItemDto itemDto) {
        ...
        Item item = itemRepository.save(MappingItem.mapToItem(itemDto, itemDto.getId(), userId));
    ...
    public CommentDto setCommentInItem(Long bookerId, Long itemId, CommentDto commentDto) {
        validationComment.validateComment(commentDto.getText());
    ...
    public ItemDto getItemDtoById(Long userId, Long itemId) {
        validationUser.validationUserById(userId);
        Item item = validationItem.validationItemById(itemId);
        List<Booking> bookings = getLastAndNextBookings(userId, itemId);
    ...
    public Collection<ItemDto> getItemsDtoByUserId(Long userId) {
        ...
        return items.stream()
                .map(item -> getItemDtoById(userId, item.getId()))
